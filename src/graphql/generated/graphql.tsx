...
export type GetCharactersQuery = { __typename?: 'Query', characters: { __typename?: 'Characters', info: { __typename?: 'Info', pages: number, next: number }, results: Array<{ __typename?: 'Character', id: string, name: string, status: string, image: string }> } };
...
export type GetCharacterQuery = { __typename?: 'Query', character: { __typename?: 'Character', species: string, type: string, gender: string, id: string, name: string, status: string, image: string, origin: { __typename?: 'Location', name: string }, location: { __typename?: 'Location', id: string, type: string, name: string, dimension: string }, episode: Array<{ __typename?: 'Episode', id: string, air_date: string, name: string, episode: string }> } };
...
export type GetEpisodesQuery = { __typename?: 'Query', episodes: { __typename?: 'Episodes', info: { __typename?: 'Info', pages: number, next: number }, results: Array<{ __typename?: 'Episode', id: string, air_date: string, name: string, episode: string }> } };
...
export type GetEpisodeQuery = { __typename?: 'Query', episode: { __typename?: 'Episode', id: string, air_date: string, name: string, episode: string, characters: Array<{ __typename?: 'Character', id: string, name: string, status: string, image: string }> } };
...
export type GetEpisodesNameQuery = { __typename?: 'Query', episodes: { __typename?: 'Episodes', results: Array<{ __typename?: 'Episode', id: string, name: string }> } };

export type CharactersFragment = { __typename?: 'Character', id: string, name: string, status: string, image: string };

export type InfoFragment = { __typename?: 'Info', pages: number, next: number };

export type CharacterFragment = { __typename?: 'Character', species: string, type: string, gender: string, id: string, name: string, status: string, image: string };

export type EpisodesFragment = { __typename?: 'Episode', id: string, air_date: string, name: string, episode: string };

export type LocationsFragment = { __typename?: 'Location', id: string, type: string, name: string, dimension: string };
...
export type GetLocationsQuery = { __typename?: 'Query', locations: { __typename?: 'Locations', info: { __typename?: 'Info', pages: number, next: number }, results: Array<{ __typename?: 'Location', id: string, type: string, name: string, dimension: string }> } };
...
export type GetLocationQuery = { __typename?: 'Query', location: { __typename?: 'Location', id: string, type: string, name: string, dimension: string, residents: Array<{ __typename?: 'Character', id: string, name: string, status: string, image: string }> } };
 ...
 * });
 */
export function useGetCharactersNameQuery(baseOptions?: Apollo.QueryHookOptions<GetCharactersNameQuery, GetCharactersNameQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCharactersNameQuery, GetCharactersNameQueryVariables>(GetCharactersNameDocument, options);
      }
export function useGetCharactersNameLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCharactersNameQuery, GetCharactersNameQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCharactersNameQuery, GetCharactersNameQueryVariables>(GetCharactersNameDocument, options);
        }
 ...
 * });
 */
export function useGetEpisodesNameQuery(baseOptions?: Apollo.QueryHookOptions<GetEpisodesNameQuery, GetEpisodesNameQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetEpisodesNameQuery, GetEpisodesNameQueryVariables>(GetEpisodesNameDocument, options);
      }
export function useGetEpisodesNameLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetEpisodesNameQuery, GetEpisodesNameQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetEpisodesNameQuery, GetEpisodesNameQueryVariables>(GetEpisodesNameDocument, options);
        }
export type GetEpisodesNameQueryHookResult = ReturnType<typeof useGetEpisodesNameQuery>;
export type GetEpisodesNameLazyQueryHookResult = ReturnType<typeof useGetEpisodesNameLazyQuery>;
export type GetEpisodesNameQueryResult = Apollo.QueryResult<GetEpisodesNameQuery, GetEpisodesNameQueryVariables>;
 ...
 * });
 */
export function useGetLocationsNameQuery(baseOptions?: Apollo.QueryHookOptions<GetLocationsNameQuery, GetLocationsNameQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLocationsNameQuery, GetLocationsNameQueryVariables>(GetLocationsNameDocument, options);
      }
export function useGetLocationsNameLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLocationsNameQuery, GetLocationsNameQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLocationsNameQuery, GetLocationsNameQueryVariables>(GetLocationsNameDocument, options);
        }
